...
FORBIDDEN_LIVE_QUOTE_IDS = frozenset(
    {
        ...
        "b5f56ac3-326d-48e9-b82d-1e09a7897107",  # Q10333 / Safe Cave / H.6.38 Contours PASS (Kyle Component→Cad + thickness + Finish; Laser costs filled) — protect like other live PASSes; never remint / PATCH / ZZ-DEL
    }
)
...
FORBIDDEN_LIVE_QUOTE_ID_PREFIXES = frozenset(
    {
        ...
        "b5f56ac3",  # Q10333 / Safe Cave / H.6.38 Contours PASS (Kyle Component→Cad + Finish; Laser costs filled) — PASS protect; never remint / PATCH / ZZ-DEL
    }
)
...
FORBIDDEN_LIVE_QUOTE_NUMBERS = frozenset(
    {
        ...
        "Q10333",  # spent b5f56ac3 / Safe Cave / H.6.38 Contours PASS — PASS protect; never remint / PATCH / ZZ-DEL
