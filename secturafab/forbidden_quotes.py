...
FORBIDDEN_LIVE_QUOTE_IDS = frozenset(
    {
        ...
        "2873e5f8-4339-41b1-ab82-2fb6a27026d3",  # Q10460 leftover — invent=false; EXEC_FAIL gate6 AddItem_DXFFiles empty body / missing List,Result after Linear stick + PR62 Finish; Contours none; OPEN-NEW 2026-09-15; never remint / PATCH (do not forbid 35146-1 — PN remints remain ALLOWED)
...
FORBIDDEN_LIVE_QUOTE_ID_PREFIXES = frozenset(
    {
        ...
        "2873e5f8",  # Q10460 leftover — EXEC_FAIL gate6 AddItem_DXFFiles empty body / missing List,Result after Linear stick + PR62 Finish; Contours none; OPEN-NEW 2026-09-15; invent=false; never remint / PATCH
...
FORBIDDEN_LIVE_QUOTE_NUMBERS = frozenset(
    {
        ...
        "Q10460",  # spent 2873e5f8 leftover — invent=false; EXEC_FAIL gate6 AddItem_DXFFiles empty body / missing List,Result after Linear stick + PR62 Finish; Contours none; OPEN-NEW 2026-09-15; never remint / PATCH (do not forbid 35146-1 — PN remints remain ALLOWED)
