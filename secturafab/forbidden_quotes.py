...
FORBIDDEN_LIVE_QUOTE_NUMBERS = frozenset(
    {
        ...
        "Q10475",  # spent eb9a17c4 / Safe Cave H.8.38 tip-prove EXEC_FAIL leftover — Contours=0; AddItem empty; meter thickness vs .1875; OPEN-NEW invent=false 2026-09-15; never remint / PATCH (do not forbid H.8.38 — PN remints remain ALLOWED). Q10470–Q10474 Contours=0 shells: UUIDs not found in live-H838-remint-kyle-path.txt / Dropbox / related logs — do not invent UUIDs.
