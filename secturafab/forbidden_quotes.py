...
FORBIDDEN_LIVE_QUOTE_IDS = frozenset(
    {
        ...
        "2cd0281e-b5eb-4b51-9796-0cec3d482eb4",  # Q10481 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — FileList Kyle HAR proved (no Status invent; ImageString omitted) + inch HARD_GATE 0.1875 PASS; AddItem List=[] → Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.10.38 — PN remints remain ALLOWED)
        "07941333-596d-4507-b72d-271a635e07d1",  # Q10482 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — FileList VALUES + AddItem List len=1 PROVED; tree prt_mill Contours=0 (need prt_dxf NoC≥1); OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.10.38 — PN remints remain ALLOWED)
        "11e2bd0a-bd0a-439b-b277-8862ac4528e2",  # Q10483 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — Stock_X/Y + List=1 + Result.NewItem PROVED; tree prt_mill Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.10.38 — PN remints remain ALLOWED)
        "98310eb3-a60d-42ea-bfa9-3fd8e408b013",  # Q10484 / Safe Cave H.6.38 tip remint leftover — edit_tab_missing abort; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.6.38 — PN remints remain ALLOWED)
        "e293584b-18bf-4114-8a07-2e2a942a941d",  # Q10485 / Safe Cave H.6.38 tip remint leftover — cookie-path prt_mill Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.6.38 — PN remints remain ALLOWED)
        "8f3a2eef-60dd-437c-a595-c63df1ded2d6",  # Q10486 / Safe Cave H.6.38 tip-prove EXEC_FAIL leftover — FileList+Stock+List=1+NewItem PROVED; tree prt_mill Contours=0; Stock dims STEP AABB not Kyle flat-pattern; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.6.38 — PN remints remain ALLOWED)
...
FORBIDDEN_LIVE_QUOTE_ID_PREFIXES = frozenset(
    {
        ...
        "2cd0281e",  # Q10481 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — FileList Kyle HAR proved (no Status invent; ImageString omitted) + inch HARD_GATE 0.1875 PASS; AddItem List=[] → Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH
        "07941333",  # Q10482 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — FileList VALUES + AddItem List len=1 PROVED; tree prt_mill Contours=0 (need prt_dxf NoC≥1); OPEN-NEW invent=false 2026-09-16; never remint / PATCH
        "11e2bd0a",  # Q10483 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — Stock_X/Y + List=1 + Result.NewItem PROVED; tree prt_mill Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH
        "98310eb3",  # Q10484 / Safe Cave H.6.38 tip remint leftover — edit_tab_missing abort; OPEN-NEW invent=false 2026-09-16; never remint / PATCH
        "e293584b",  # Q10485 / Safe Cave H.6.38 tip remint leftover — cookie-path prt_mill Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH
        "8f3a2eef",  # Q10486 / Safe Cave H.6.38 tip-prove EXEC_FAIL leftover — FileList+Stock+List=1+NewItem PROVED; tree prt_mill Contours=0; Stock dims STEP AABB not Kyle flat-pattern; OPEN-NEW invent=false 2026-09-16; never remint / PATCH
...
FORBIDDEN_LIVE_QUOTE_NUMBERS = frozenset(
    {
        ...
        "Q10481",  # spent 2cd0281e / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — FileList Kyle HAR proved (no Status invent; ImageString omitted) + inch HARD_GATE 0.1875 PASS; AddItem List=[] → Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.10.38 — PN remints remain ALLOWED)
        "Q10482",  # spent 07941333 / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — FileList VALUES + AddItem List len=1 PROVED; tree prt_mill Contours=0 (need prt_dxf NoC≥1); OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.10.38 — PN remints remain ALLOWED)
        "Q10483",  # spent 11e2bd0a / Safe Cave H.10.38 tip-prove EXEC_FAIL leftover — Stock_X/Y + List=1 + Result.NewItem PROVED; tree prt_mill Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.10.38 — PN remints remain ALLOWED)
        "Q10484",  # spent 98310eb3 / Safe Cave H.6.38 tip remint leftover — edit_tab_missing abort; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.6.38 — PN remints remain ALLOWED)
        "Q10485",  # spent e293584b / Safe Cave H.6.38 tip remint leftover — cookie-path prt_mill Contours=0; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.6.38 — PN remints remain ALLOWED)
        "Q10486",  # spent 8f3a2eef / Safe Cave H.6.38 tip-prove EXEC_FAIL leftover — FileList+Stock+List=1+NewItem PROVED; tree prt_mill Contours=0; Stock dims STEP AABB not Kyle flat-pattern; OPEN-NEW invent=false 2026-09-16; never remint / PATCH (do not forbid H.6.38 — PN remints remain ALLOWED)
        ...
        # Do not remint 21785-1 / 21785-2 / 21785-3 / 35145-1 / Q10243 / P904272-1 / P904271-1 / 10289-4 / 10289-5 / 28768-1 / 28769-1 / 35136-1 / 14327-5 / 14327-8 / Q10329 / 14327-3 / Q10330 / 21841-1 / Q10331 / 14327-1 / Q10332 / Q10333 / Q10336 / Q10339 / Q10344 / Q10346 / B80510901 / Q10348 / H.16.70 / Q10349 / D.H.30.96 / Q10351 / H.8.38 / Q10354 / D.H.38.96 / Q10356 / V.20.78 / Q10365 / H.10.38 / Q10366 / H.6.38 / Q10367 / Q10369 / Q10368 / Q10371 / Q10372 / Q10373 / Q10374 / Q10375 / Q10377 / Q10379 / Q10380 / Q10381 / Q10382 / Q10383 / Q10399 / Q10420 / Q10450 / Q10429 / Q10475 / Q10476 / Q10479 / Q10480 / Q10481 / Q10482 / Q10483 / Q10484 / Q10485 / Q10486 / Q10470 / Q10471 / Q10472 / Q10473 / Q10474 / Q10421 / Q10407 / Q10408 / Q10358 / Q10359 / Q10350 / 21843-1 / Q10338 / CROSSDRAIN-12X7X60 / H638-CADPLATE / Q10334 / Q10335 / 28898-1 / 28772-1 / 14327-18 / 15911-9 / 21839-1 / GSB20570006.
