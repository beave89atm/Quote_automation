...
FORBIDDEN_LIVE_QUOTE_IDS = frozenset(
    {
        ...
        "d796cdbe-b4b6-4d64-937f-826f19efa623",  # Q10407 / Safe Cave H.8.42 Contours FAIL leftover @ c08c47b — invent=false; OPEN-NEW; POST /part/create List=[] empty InternalData; Contours never filled; never remint / PATCH (do not forbid H.8.42 — PN remints remain ALLOWED)
        "09bae33d-f244-4afb-a25e-b40a98b725d1",  # Q10408 / Safe Cave H.32.72.WBT Contours FAIL leftover @ c08c47b — invent=false; OPEN-NEW; same POST /part/create List=[] empty InternalData class as Q10407; Contours never filled; never remint / PATCH (do not forbid H.32.72.WBT — PN remints remain ALLOWED)
...
FORBIDDEN_LIVE_QUOTE_ID_PREFIXES = frozenset(
    {
        ...
        "d796cdbe",  # Q10407 / Safe Cave H.8.42 Contours FAIL leftover @ c08c47b — POST /part/create List=[] empty InternalData; Contours never filled; invent=false; OPEN-NEW; never remint / PATCH
        "09bae33d",  # Q10408 / Safe Cave H.32.72.WBT Contours FAIL leftover @ c08c47b — same POST /part/create List=[] empty InternalData class as Q10407; Contours never filled; invent=false; OPEN-NEW; never remint / PATCH
...
FORBIDDEN_LIVE_QUOTE_NUMBERS = frozenset(
    {
        ...
        "Q10407",  # spent d796cdbe / Safe Cave H.8.42 Contours FAIL leftover @ c08c47b — invent=false; OPEN-NEW; POST /part/create List=[] empty InternalData; Contours never filled; never remint / PATCH (do not forbid H.8.42 — PN remints remain ALLOWED)
        "Q10408",  # spent 09bae33d / Safe Cave H.32.72.WBT Contours FAIL leftover @ c08c47b — invent=false; OPEN-NEW; same POST /part/create List=[] empty InternalData class as Q10407; Contours never filled; never remint / PATCH (do not forbid H.32.72.WBT — PN remints remain ALLOWED)
