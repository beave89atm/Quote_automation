...
FORBIDDEN_LIVE_QUOTE_IDS = frozenset(
    {
        ...
        "b5f56ac3-326d-48e9-b82d-1e09a7897107",  # Q10333 / Safe Cave / H.6.38 Onshape STEP — leftover captured Contours-absent; Kyle later proved Component→Cad unlocks Contours (human Finish OK). Forever-forbid remint/PATCH. ZZ-DEL-Q10333-H638-SafeCave-contours
    }
)
...
FORBIDDEN_LIVE_QUOTE_ID_PREFIXES = frozenset(
    {
        ...
        "b5f56ac3",  # Q10333 / Safe Cave / H.6.38 — leftover Contours-absent; Kyle Component→Cad Contours proof (human Finish OK); do not remint / PATCH
    }
)
...
FORBIDDEN_LIVE_QUOTE_NUMBERS = frozenset(
    {
        ...
        "Q10333",  # spent b5f56ac3 / Safe Cave / H.6.38 — leftover Contours-absent; Kyle Component→Cad unlocks Contours (human Finish OK); invented=false; do not remint / PATCH
