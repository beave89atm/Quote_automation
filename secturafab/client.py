...
class SecturaFabClient:
    ...
    def _pdf_finish_capture(result: dict[str, Any], *, via: str) -> dict[str, Any]:
        ...
        return {
            ...
            "filelist_producttype": str(result.get("filelist_producttype") or ""),
            "filelist_productsubtype": str(result.get("filelist_productsubtype") or ""),
            "filelist_itemtype": str(result.get("filelist_itemtype") or ""),
