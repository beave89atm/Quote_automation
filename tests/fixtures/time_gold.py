...
CLASSIFY_CASES: list[tuple[str, str, str]] = [
    ...
    ("21689-1", "HOSE GUARD", "Linear"),
    ("15891-1", "HOSE GUARD", "Linear"),
    ("21679-1", "HOSEGUARD TUBE", "Linear"),
    ("thk-075", '3/4" A36 PLATE', "Cad"),
    ("thk-125", '1.25" A572 PLATE', "Component"),
    ("thk-114", '1 1/4" A572 PLATE', "Component"),
    ("formed-ang", "FORMED ANGLE 1/4 A36 PLATE", "Cad"),
    ("hose-tube", "PEDESTAL HOSE TUBE", "Linear"),
