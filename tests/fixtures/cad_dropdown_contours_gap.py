...
Live leftovers after Cad-for-plate:
  ...
  0c62fce9 Q10351 — Safe Cave H.8.38 Contours PASS leftover.
    ...
    Finish. invent=false.
  7881d4b3 Q10354 — Safe Cave D.H.38.96 Contours FAIL leftover.
    Cad selector + 0.1875 in set, finished ProductType part;
    NumberOfContours unavailable / Contours PASS not proven.
    Same empty-InternalData Contours-FAIL class as Q10334 /
    Q10335. invent=false. Not Q10349 / D.H.30.96 PASS.
  05bee105 Q10356 — Safe Cave V.20.78 Contours FAIL leftover.
    Cad selector + 0.1875 in set, finished ProductType part;
  ...
  7801ab99 Q10365 — Safe Cave H.10.38 Contours FAIL leftover.
    ...
    PartImage / UpdateData / CADData; fill_xhr=null;
    NumberOfContours unavailable. Same FAIL class as Q10354 /
    Q10356. UpdateItemType is ItemType only — does not write
    ProductType. PASSes Q10333 / Q10348 finish ProductType=100 +
    NumberOfContours=1 — do not refuse enum 100. invent=false.
    Forever-forbid; never remint.
