...
LIVE_28769_1_CADIMPORT_EMPTY: dict[str, Any] = {
    ...
    "routes": {
        ...
        "GET /CadImport/CADData": {
            ...
            "bindable": False,
            "editor_preview": True,
            "leftover_preview": True,
            "n": 1,
            "keys": ("Length", "Width", "WebGL", "InternalData"),
        },
    },
    # Key names / emptiness only — never contour JSON or WebGL blobs.
    "leftover_caddata_preview": {
        "Length": 0,
        "Width": 0,
        "WebGL": "",
        "InternalData": "",
    },
    "leftover_explode_kid": {
        "SourceDataID": "",
        "ID": "",
        "FileID": "",
        "InternalData": "",
